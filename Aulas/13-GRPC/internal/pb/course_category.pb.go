...
func (x *CategoryGetRequest) GetCategoryId() string {
	if x != nil {
		return x.CategoryId
	}
	return ""
...
func (x *SearchCategoryRequest) GetCourseId() string {
	if x != nil {
		return x.CourseId
	}
	return ""
...
func (x *SearchCategoryRequest) GetCategoryId() string {
	if x != nil {
		return x.CategoryId
	}
	return ""
...
func (x *SearchCategoryRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *SearchCategoryRequest) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"categories\"4\n" +
	"\x12CategoryGetRequest\x12\x1e\n" +
	"\n" +
	"categoryId\x18\x01 \x01(\tR\n" +
	"categoryId\"\x89\x01\n" +
	"\x15SearchCategoryRequest\x12\x1a\n" +
	"\bcourseId\x18\x01 \x01(\tR\bcourseId\x12\x1e\n" +
	"\n" +
	"categoryId\x18\x02 \x01(\tR\n" +
	"categoryId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription2\xdf\x02\n" +
	"\x0fCategoryService\x12A\n" +
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\x14.pb.CategoryResponse\x12D\n" +
	"\x13CreateCategorySream\x12\x19.pb.CreateCategoryRequest\x1a\x10.pb.CategoryList(\x01\x12-\n" +
	"\x0eListCategories\x12\t.pb.blank\x1a\x10.pb.CategoryList\x12?\n" +
	"\x0fGetCategoryById\x12\x16.pb.CategoryGetRequest\x1a\x14.pb.CategoryResponse\x12S\n" +
	"\x1cCreateCategoryStreamBothWays\x12\x19.pb.CreateCategoryRequest\x1a\x14.pb.CategoryResponse(\x010\x01B\rZ\vinternal/pbb\x06proto3"
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*SearchCategoryRequest)(nil), // 6: pb.SearchCategoryRequest
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	2, // 3: pb.CategoryService.CreateCategorySream:input_type -> pb.CreateCategoryRequest
	1, // 4: pb.CategoryService.ListCategories:input_type -> pb.blank
	5, // 5: pb.CategoryService.GetCategoryById:input_type -> pb.CategoryGetRequest
	2, // 6: pb.CategoryService.CreateCategoryStreamBothWays:input_type -> pb.CreateCategoryRequest
	3, // 7: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	4, // 8: pb.CategoryService.CreateCategorySream:output_type -> pb.CategoryList
	4, // 9: pb.CategoryService.ListCategories:output_type -> pb.CategoryList
	3, // 10: pb.CategoryService.GetCategoryById:output_type -> pb.CategoryResponse
	3, // 11: pb.CategoryService.CreateCategoryStreamBothWays:output_type -> pb.CategoryResponse
